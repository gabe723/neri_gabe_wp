...
class ACS_Color_Schemes {
	...
	private $colors = array(
		...
		'cruise', 'flat', 'lawn', 'seashore', 'gabe'
	);
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'gabe', __( 'Gabe', 'admin_schemes' ),
			plugins_url( "gabe/colors$suffix.css", __FILE__ ),
			array( 'red', 'white', 'blue', 'black' ),
			array( 'base' => 'red', 'focus' => 'white', 'current' => 'blue' )
		);
